...
2. As propriedades do banco de dados já estão no arquivo `application.properties`, você só precisa criar um banco de dados com o nome CRUD, usuário postgres e senha 123456.
